...
const HowItWorks = () => {
  ...
  const step1Color = useTransform(scrollYProgress, [0.15, 0.23], ['var(--border-subtle)', '#4f46e5']);

  // Step 2 Transforms
  const step2Opacity = useTransform(scrollYProgress, [0.45, 0.53], [0, 1]);
  const step2Color = useTransform(scrollYProgress, [0.45, 0.53], ['var(--border-subtle)', '#4f46e5']);

  // Step 3 Transforms
  const step3Opacity = useTransform(scrollYProgress, [0.73, 0.81], [0, 1]);
  const step3Color = useTransform(scrollYProgress, [0.73, 0.81], ['var(--border-subtle)', '#4f46e5']);
  ...
  return (
    <section id="how-it-works" className="bg-transparent">
      <div ref={wrapperRef} style={{ height: '300vh' }} className="relative hidden md:block">
        <div className="sticky top-0 h-screen flex flex-col items-center justify-center overflow-hidden px-6">
          ...
          <div className="text-center mb-4 mt-[-40px]">
            ...
            <h2 className="font-display text-4xl md:text-5xl text-theme-primary leading-tight max-w-2xl mx-auto">
          ...
          <div className="w-full max-w-6xl mx-auto">
            <svg viewBox="0 0 1200 280" width="100%" preserveAspectRatio="xMidYMid meet" overflow="visible">
              ...
              {/* Background path */}
              <path ref={pathRef} d={pathD} fill="none" stroke="var(--border-subtle)" strokeWidth={3} />
            ...
            <div className="grid grid-cols-3 gap-8 -mt-32 relative z-10 px-4">
              ...
              <motion.div style={{ opacity: step1Opacity }} className="flex flex-col items-center text-center">
                ...
                <Card variant="glass" className="w-full flex flex-col items-center p-6 text-center">
                  ...
                  <h3 className="font-sans font-medium text-lg text-theme-primary mb-3">
                    Message comes in
                  </h3>
      ...
      {/* MOBILE FALLBACK */}
      <div className="md:hidden px-6 py-24 bg-theme-bg">
        <div className="text-center mb-16">
          <p className="section-label mb-3">
            HOW IT WORKS
          </p>
          <h2 className="font-display text-4xl text-theme-primary leading-tight">
            Three steps to a smarter sales conversation.
          </h2>
        </div>
