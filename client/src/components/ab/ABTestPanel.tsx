...
export default function ABTestPanel() {
  ...
  if (isPending) {
    return (
      <div className="px-6 py-8 overflow-y-auto h-full bg-theme-surface">
        <Header />
  ...
  return (
    <div className="px-6 py-8 overflow-y-auto h-full bg-theme-surface">
      ...
      {isEmpty && (
        <div className="mb-6 rounded-2xl border border-theme-border bg-theme-surface-solid p-8 text-center shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <motion.div 
            ...
            className={`bg-theme-surface-solid border-2 rounded-2xl p-6 relative ${!adaptiveWins && totalSessions > 0 ? 'border-[#dd6668]' : 'border-theme-border'}`}
          >
          ...
          <motion.div 
            ...
            whileHover={{ y: -2, boxShadow: "0 8px 30px rgba(28,46,30,0.08)" }}
            transition={{ type: "spring", stiffness: 400, damping: 25 }}
            className={`bg-theme-surface-solid border-2 rounded-2xl p-6 relative ${adaptiveWins ? 'border-[#dd6668] bg-theme-surface/30 shadow-[0_12px_40px_rgba(77,109,71,0.14)]' : 'border-theme-border'}`}
          >
      ...
      {data.static_conversion_rate > 0 && adaptiveWins && (
        ...
        >
            <div className="mb-6 bg-theme-surface rounded-2xl px-6 py-4 flex items-center justify-center space-x-3 text-[#dd6668] font-medium">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-12">
        ...
        <motion.div 
          ...
          className="bg-theme-surface-solid border border-theme-border rounded-2xl p-6 shadow-sm flex flex-col"
        >
        ...
        >
          {/* STATIC Column */}
          <motion.div variants={itemVariants} className="bg-theme-surface-solid border border-theme-border rounded-xl p-4 flex flex-col items-center justify-center text-center shadow-sm">
          ...
          {/* ADAPTIVE Column */}
          <motion.div variants={itemVariants} className="bg-theme-surface/50 border border-[#dd6668]/20 rounded-xl p-4 flex flex-col items-center justify-center text-center shadow-sm">
          ...
          <motion.div variants={itemVariants} className="bg-theme-surface-solid border border-theme-border rounded-xl p-4 flex flex-col items-center justify-center text-center shadow-sm">
            ...
            <p className="text-xl font-display font-normal text-theme-primary">{staticRate}%</p>
          </motion.div>

          <motion.div variants={itemVariants} className="bg-theme-surface/50 border border-[#dd6668]/20 rounded-xl p-4 flex flex-col items-center justify-center text-center shadow-sm">
            <p className="text-xs font-sans font-medium uppercase tracking-widest text-[#dd6668] mb-1">Adaptive Conv.</p>
            <p className="text-xl font-display font-normal text-theme-primary">{adaptiveRate}%</p>
          </motion.div>
